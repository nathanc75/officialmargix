...
const LeakResults = () => {
  ...
  const handleExport = () => {
    ...
    const reportContent = `
MARGIX LEAK SCAN REPORT
Generated: ${new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
==================================================

SUMMARY
-------
Total Leaks Found: ${leakAnalysis.totalLeaks}
Total Recoverable: ${formatCurrency(leakAnalysis.totalRecoverable)}
...
${index + 1}. ${getLeakTypeLabel(leak.type)} - ${leak.severity.toUpperCase()} Severity
   Amount: ${formatCurrency(leak.amount)}
   Date: ${leak.date}
   Description: ${leak.description}
   Recommendation: ${leak.recommendation || 'Review and take action'}
`).join('\n')}

==================================================
Report generated by MARGIX AI Financial Monitor
    `.trim();
    ...
    a.href = url;
    a.download = `margix-leak-report-${new Date().toISOString().split('T')[0]}.txt`;
