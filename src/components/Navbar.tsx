...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-4 left-4 right-4 z-50 mx-auto max-w-7xl hero-gradient backdrop-blur-md rounded-2xl shadow-lg shadow-black/10 dark:shadow-black/30">
