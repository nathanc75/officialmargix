        ...
        <div className="flex h-16 items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-2 ml-4">
              <Badge variant="secondary" className="gap-1.5 py-1 px-2.5 text-xs bg-emerald-500/10 text-emerald-600 border-emerald-500/20 font-bold">
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-2 bg-muted/50 p-1.5 rounded-lg border">
              <Select value={platform} onValueChange={setPlatform}>
                <SelectTrigger className="w-[140px] h-9 text-sm border-0 bg-transparent focus:ring-0 font-semibold">
