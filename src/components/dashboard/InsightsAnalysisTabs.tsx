          ...
          <TabsContent value="promos" className="mt-0 space-y-4">
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="space-y-1">
                      ...
                      <Badge variant="outline" className="text-[10px] font-bold uppercase border-0 bg-muted/50 px-1.5 font-medium">
                        {promo.platform}
                      </Badge>
                    </div>
            ...
            <div className="p-4 rounded-xl bg-amber-500/5 border border-amber-500/10">
              <div className="flex items-center gap-3">
                ...
                <p className="text-xs font-medium text-amber-900 dark:text-amber-100 font-medium">
          ...
          <TabsContent value="ai" className="mt-0 space-y-4">
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="space-y-1">
                        <p className="font-bold text-sm leading-none tracking-tight">{rec.action}</p>
                        <p className="text-xs text-muted-foreground leading-relaxed font-medium">{rec.reason}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-600 border-emerald-500/20 font-bold text-[10px] uppercase h-6 font-medium">
                        {rec.impact}
                      </Badge>
            ...
            <div className="p-4 rounded-xl bg-primary/5 border border-primary/10">
              <div className="flex items-center gap-3">
                ...
                <p className="text-xs font-medium text-foreground font-medium">
